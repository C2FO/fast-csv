 ...
 * these by including the ignoreEmpty option. Any rows consisting of nothing but empty strings and/or commas will be
 * skipped, without emitting a 'data' or 'error' event.
 *
 * ```javascript
 * var stream = fs.createReadStream("my.csv");
 *
